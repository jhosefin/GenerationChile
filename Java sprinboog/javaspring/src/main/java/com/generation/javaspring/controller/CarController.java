...
import com.generation.javaspring.service.CarService;
...
public class CarController {
    ...
    @GetMapping("/Car/eliminarAuto/{id}")
    public void deleteAuto(@PathVariable Integer id){
        carService.eliminarAuto(id);//estos deben llevar el mismo nombre que en le service
    }
}
