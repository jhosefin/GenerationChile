...
public class Calculadora {
    public static void main(String[] args) {
        ...
        if(venta > 10000){
            System.out.println("Su comision es de: "+ (venta * 0.3) + " correspondientes al 30%");
            System.out.println("-----------------------------------------");
        }else if( venta >= 5000 && venta <= 9999){
            System.out.println("Su comision es de: "+ (venta * 0.2) + " correspondientes al 20%");
            System.out.println("-----------------------------------------");
    
        }else if(venta >= 1001 && venta <= 4999){
            System.out.println("Su comision es de: "+ (venta * 0.1) + " correspondientes al 10%");
            System.out.println("-----------------------------------------");
    
        }else{
            System.out.println("No le corresponde comision");
            System.out.println("-----------------------------------------");
